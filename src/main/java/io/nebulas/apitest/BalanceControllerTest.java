...
public class BalanceControllerTest {
    ...
    public void testCorrectResponse() {
        given().
                headers(headers).
                body(requestBody).
                post("/balance").then().assertThat().statusCode(200).body(matchesJsonSchemaInClasspath("BalanceControllerResponse.json"));
    }
    ...
    public void testResponse() {
        given().
                headers(headers).
                body(requestBody).
                post("/balancecurrency").then().assertThat().statusCode(200).body(matchesJsonSchemaInClasspath("BalanceControllerResponse.json"));
    }
}
